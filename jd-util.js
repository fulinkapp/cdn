...
class MonsterNian {
    constructor(params, containerDiv, outputTextarea) {
        this.detailurl = "https://api.m.jd.com/client.action?functionId=nian_getTaskDetail";
        this.data = [];
        this.timer = 1000;
        this.taskToken = "";
        this.params = params;
    ...
    list() {
        ...
        const o = utils_1._$('.shop'), h = utils_1._$('.help'), a = utils_1._$('.activity'), v = utils_1._$('.viewActive'), r = utils_1._$('.record'), s = utils_1._$('.shopping'), i = utils_1._$('.invite'), g = utils_1._$('.group'), b = utils_1._$('.raise'), u = utils_1._$('.auto'), browser = utils_1._$('.browser'), assistGroup = utils_1._$('.assistGroup'), invite = utils_1._$('.inviteLink'), assist = utils_1._$('.assist'), l = utils_1._$('.product');
        o.addEventListener('click', () => {
            utils_1.default.outPutLog(this.outputTextarea, `开始自动逛逛好店任务`);
            this.send(this.data.taskVos[3]["browseShopVo"], this.data.taskVos[3]["taskId"]);
        });
        l.addEventListener('click', () => {
            utils_1.default.outPutLog(this.outputTextarea, `开始自动好物加购任务`);
        ...
        v.addEventListener('click', () => {
            utils_1.default.outPutLog(this.outputTextarea, `开始自动浏览活动任务`);
            this.send(this.data.taskVos[2]["shoppingActivityVos"], this.data.taskVos[2]["taskId"]);
        });
        r.addEventListener('click', () => {
            utils_1.default.outPutLog(this.outputTextarea, `开始自动LBS定位任务`);
            this.send([this.data.taskVos[7]["simpleRecordInfoVo"]], this.data.taskVos[7]["taskId"]);
        });
        browser.addEventListener('click', () => {
            utils_1.default.outPutLog(this.outputTextarea, `开始自动逛主会场任务`);
            this.doTask();
        });
        ...
        i.addEventListener('click', () => {
            utils_1.default.copyText(`https://bunearth.m.jd.com/babelDiy/SGFJVMOZADGTQCZWGEYU/4PWgqmrFHunn8C38mJA712fufguU/index.html?shareType=taskHelp&inviteId=${this.data["inviteId"]}&taskId=1&itemId=${this.data["taskVos"][0]["assistTaskDetailVo"]["itemId"]}&shareFrom=key`);
        });
        ...
        u.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            utils_1.default.outPutLog(this.outputTextarea, `一键自动开始任务！`);
            this.help();
            utils_1.default.outPutLog(this.outputTextarea, `开始自动逛逛好店任务`);
            yield this.send(this.data.taskVos[3]["browseShopVo"], this.data.taskVos[3]["taskId"]);
            utils_1.default.outPutLog(this.outputTextarea, `开始自动好物加购任务`);
            yield this.send(this.data.taskVos[2]["productInfoVos"], this.data.taskVos[2]["taskId"]);
            utils_1.default.outPutLog(this.outputTextarea, `开始自动逛逛会场任务`);
            yield this.send(this.data.taskVos[4]["shoppingActivityVos"], this.data.taskVos[4]["taskId"]);
            utils_1.default.outPutLog(this.outputTextarea, `开始自动好玩互动任务`);
            yield this.send(this.data.taskVos[5]["shoppingActivityVos"], this.data.taskVos[5]["taskId"]);
            utils_1.default.outPutLog(this.outputTextarea, `开始自动视频直播任务`);
            yield this.send(this.data.taskVos[6]["shoppingActivityVos"], this.data.taskVos[6]["taskId"]);
            utils_1.default.outPutLog(this.outputTextarea, `全部任务完成`);
            // o!.dispatchEvent(e);
            // a!.dispatchEvent(e);
            // v!.dispatchEvent(e);
            // s!.dispatchEvent(e);
            ...
            for (let i = 0; i < length; i++) {
                ...
                yield new Promise(resolve => {
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        yield fetch("https://api.m.jd.com/client.action?functionId=nian_collectScore", {
                            method: "POST",
                            mode: "cors",
                            credentials: "include",
                            headers: {
    ...
    doTask() {
        fetch(" https://api.m.jd.com/client.action?functionId=tc_doTask_mongo", {
            ...
            utils_1.default.outPutLog(this.outputTextarea, `任务领取成功！`);
            this.broswer();
        });
    }
    broswer() {
        fetch(`https://api.m.jd.com/client.action?functionId=tc_doTask_mongo&body=%7B%22taskToken%22%3A%22${this.taskToken}%22%2C%22actionType%22%3A0%7D&area=&networkType=&t=1578487649503&appid=publicUseApi&client=wh5&clientVersion=1.0.0`, {
            ...
            if (res.data.bizCode == 0) {
                utils_1.default.outPutLog(this.outputTextarea, `操作成功！`);
            }
        });
    }
    raise() {
    ...
    help() {
        utils_1.default.outPutLog(this.outputTextarea, `操作成功！谢谢你为我的队伍助力！`);
    ...
    group() {
        fetch('https://api.m.jd.com/client.action?functionId=nian_pk_getHomeData', {
            ...
            utils_1.default.copyText(`https://bunearth.m.jd.com/babelDiy/ZTSKYQHOPNHCVTWNJSQF/4PWgqmrFHunn8C38mJA712fufguU/index.html?shareType=pk&inviteId=${groupAssistInviteId}`);
        });
    }
    assistGroup(url) {
        ...
        const inviteId = utils_1.default.getSearchString(url, "inviteId") || url;
        fetch('https://api.m.jd.com/client.action?functionId=nian_pk_assistGroup', {
            method: "POST",
            mode: "cors",
            credentials: "include",
    ...
    assist(url) {
        ...
        const inviteId = utils_1.default.getSearchString(url, "inviteId"), itemId = utils_1.default.getSearchString(url, "itemId");
        fetch('https://api.m.jd.com/client.action?functionId=nian_collectScore', {
            method: "POST",
            mode: "cors",
            credentials: "include",
...
exports.default = MonsterNian;

},{"../config/config":6,"../utils/utils":31}],2:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../utils/utils":31}],3:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
                    ...
                    yield new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield utils_1.default.request("stall_collectScore", postData).then(() => {
                            ...
                            utils_1.default.request('followShop', { "shopId": data[i]['shopId'], "follow": true, "type": "0" }).then(() => __awaiter(this, void 0, void 0, function* () {
                                ...
                                utils_1.default.request('stall_collectScore', postData).then((res) => {
                                    var _a, _b;
                                    utils_1.default.outPutLog(self.outputTextarea, `${(_b = (_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.result) === null || _b === void 0 ? void 0 : _b.successToast}`);
                                    utils_1.default.outPutLog(self.outputTextarea, `操作成功！任务序号：${i + 1}/${length}`);
                                    if (i + 1 >= length) {
                                        utils_1.default.outPutLog(self.outputTextarea, `当前任务已完成!`);
                                    }
...
},{"../config/config":6,"../utils/utils":31}],4:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../config/config":6,"../utils/utils":31}],5:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../config/config":6,"../utils/utils":31}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Config {
}
...
},{"../config/config":6,"../utils/fetch-jsonp":30,"../utils/utils":31,"./CookieHandler":7}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
class CoinPurchase {
...
},{"../utils/utils":31}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
class Exchange {
...
},{"../utils/utils":31}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
class GcConvert {
...
},{"../utils/utils":31}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
const fetch_jsonp_1 = require("../utils/fetch-jsonp");
...
},{"../utils/fetch-jsonp":30,"../utils/utils":31}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
class Mfreecoupon {
...
},{"../utils/utils":31}],14:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
...
},{"../utils/utils":31}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
class Purchase {
...
},{"../utils/utils":31}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
class ReceiveCoupon {
...
},{"../utils/utils":31}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
...
},{"../utils/utils":31}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
...
},{"../utils/utils":31}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
class SecKillCoupon {
...
},{"../utils/utils":31}],22:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../config/config":6,"../cookie/CookieHandler":7,"../cookie/CookieManager":8,"../utils/utils":31}],26:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
                            ...
                            yield fetch(`${this.rootURI}${url}`, {
                                ...
                                if (res.resultCode == 0) {
                                    ...
                                    if (resultCode == 0) {
                                        ...
                                        utils_1.default.outPutLog(this.outputTextarea, `【${item["mark"]}】:获得【"${((_a = result === null || result === void 0 ? void 0 : result.award) === null || _a === void 0 ? void 0 : _a.name) ? (_b = result === null || result === void 0 ? void 0 : result.award) === null || _b === void 0 ? void 0 : _b.name : "空箱子"}】`);
                                    }
                    ...
                    yield fetch(`${this.rootURI}${url}`, {
                        ...
                        if (res.resultCode == 0) {
                            if (res.resultData.resultCode == 0) {
                                let result = res.resultData.resultData;
                                utils_1.default.outPutLog(this.outputTextarea, `${((_a = result === null || result === void 0 ? void 0 : result.award) === null || _a === void 0 ? void 0 : _a.name) ? "获得:" + ((_b = result === null || result === void 0 ? void 0 : result.award) === null || _b === void 0 ? void 0 : _b.name) : "这是个空箱子"}`);
                            }
                            else {
        ...
        fetch(this.rootURI + "pigPetLogin", {
            ...
            if (res.resultCode == 0) {
                ...
                if (data.hasPig) {
                    ...
                    let pig = (_a = data === null || data === void 0 ? void 0 : data.cote) === null || _a === void 0 ? void 0 : _a.pig, pigName = pig === null || pig === void 0 ? void 0 : pig.pigName, percent = pig.percent, weight = pig.weight, favFood = pig.favFood;
                    if (config_1.default.multiFlag && ckObj) {
    ...
    achievements(ckObj) {
        fetch(this.rootURI + "pigPetAchievements", {
            ...
            if (res.resultCode == 0) {
                let data = res.resultData.resultData;
                if (res.resultData.resultCode == 0) {
                    let currentCash = data === null || data === void 0 ? void 0 : data.currentCash, limitCash = data === null || data === void 0 ? void 0 : data.limitCash;
                    if (config_1.default.multiFlag && ckObj) {
    ...
    lotteryIndex(ckObj) {
        fetch(this.rootURI + "pigPetLotteryIndex", {
            ...
            if (res.resultCode == 0) {
                let data = res.resultData.resultData;
                if (res.resultData.resultCode == 0) {
                    let currentCount = data === null || data === void 0 ? void 0 : data.currentCount, coinCount = data === null || data === void 0 ? void 0 : data.coinCount, price = data === null || data === void 0 ? void 0 : data.price, nextFreeTime = data === null || data === void 0 ? void 0 : data.nextFreeTime;
                    if (config_1.default.multiFlag && ckObj) {
    ...
    signOne(ckObj) {
        fetch(this.rootURI + "pigPetSignOne?_=" + utils_1.default.getTimestamp(), {
            ...
            if (res.resultCode == 0) {
                let data = res.resultData.resultData;
                if (res.resultData.resultCode == 0) {
                    let today = data === null || data === void 0 ? void 0 : data.today, name = (_a = data === null || data === void 0 ? void 0 : data.award) === null || _a === void 0 ? void 0 : _a.name;
                    if (config_1.default.multiFlag && ckObj) {
    ...
    signIndex(ckObj) {
        fetch(this.rootURI + "pigPetSignIndex?_=" + utils_1.default.getTimestamp(), {
            ...
            if (res.resultCode == 0) {
                let data = res.resultData.resultData;
                if (res.resultData.resultCode == 0) {
                    let today = data === null || data === void 0 ? void 0 : data.today;
                    if (config_1.default.multiFlag && ckObj) {
                        ckObj.signNo = today;
    ...
    userBag(ckObj) {
        fetch(this.rootURI + "pigPetUserBag?_=" + utils_1.default.getTimestamp(), {
            ...
            if (res.resultCode == 0) {
                let data = res.resultData.resultData;
                if (res.resultData.resultCode == 0) {
                    let goods = data === null || data === void 0 ? void 0 : data.goods, goodStr = "";
                    if (config_1.default.multiFlag && ckObj) {
...
},{"../config/config":6,"../cookie/CookieHandler":7,"../cookie/CookieManager":8,"../utils/utils":31}],27:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"../config/config":6,"../cookie/CookieHandler":7,"../cookie/CookieManager":8,"../utils/utils":31}],28:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils/utils");
const config_1 = require("../config/config");
...
},{"../config/config":6,"../utils/fetch-jsonp":30,"../utils/utils":31}],29:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
const MonsterNian_1 = require("./activitys/MonsterNian");
...
function getEntryType() {
    ...
    if (config_1.default.locationHref.includes("bunearth.m.jd.com")) {
        if (config_1.default.locationHref.includes("2cKMj86srRdhgWcKonfExzK4ZMBy")) {
...
function getEntryDesc(type) {
    ...
    switch (type) {
        ...
        case couponType_1.couponType.receiveSeckillReward:
            ...
            break;
        case activityType_1.activityType.monsterNian:
            activity = new MonsterNian_1.default(null, container, outputTextArea);
...
},{"./activitys/MonsterNian":1,"./activitys/guardianstar":2,"./activitys/stall":3,"./activitys/starMall":4,"./activitys/timeMachine":5,"./config/config":6,"./cookie/CookieHandler":7,"./cookie/CookieManager":8,"./coupons/coinPurchase":9,"./coupons/exchange":10,"./coupons/gcConvert":11,"./coupons/getCouponCenter":12,"./coupons/mfreecoupon":13,"./coupons/newBabelAwardCollection":14,"./coupons/purchase":15,"./coupons/receiveCoupon":16,"./coupons/receiveCoupons":17,"./coupons/receiveDayCoupon":18,"./coupons/receiveSeckillReward":19,"./coupons/secKillCoupon":20,"./coupons/whtieCoupon":21,"./enum/activityType":22,"./enum/couponType":23,"./enum/goodsType":24,"./game/btgoose":25,"./game/cloudpig":26,"./game/signInCenter":27,"./goods/goods":28,"./utils/utils":31}],30:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class FetchJsonp {
